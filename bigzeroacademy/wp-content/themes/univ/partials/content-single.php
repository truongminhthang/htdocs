...
*/
echo layers_post_featured_media( array( 'postid' => get_the_ID(), 'wrap_class' => 'thumbnail blogimage100 push-bottom', 'size' => 'univ_single_blog_image' ) );
...
if ( '' != get_the_content() ) { ?>
	...
	*/
	wp_link_pages( array(
		'link_before'   => '<span>',
		'link_after'    => '</span>',
		'before'        => '<p class="inner-post-pagination">' . __('<span>Pages:</span>', 'univ'),
		'after'     => '</p>'
	)); ?>
