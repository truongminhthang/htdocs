<?php
/**
 * Template Name: Univ Blog Both Sidebar
 *
		...
		<article class="column span-6" >
				...
				if ( $wp_query->have_posts() ) : ?>
					...
					<?php while ( $wp_query->have_posts() ) : $wp_query->the_post();?>
						<div class="blog-info-both" id="post-<?php the_ID(); ?>">
							...
							<div class="single-blog-item overlay-hover single-blog-pading">
								...
								<div class="single-blog-image">
										...
										*/
										echo layers_post_featured_media( array( 'postid' => get_the_ID(), 'wrap_class' => 'overlay-effect', 'size' => 'univ_both_blog_image' ) ); ?>
								</div>
								<?php }else{ ?>
									<?php /**
										* Display the Featured Thumbnail
