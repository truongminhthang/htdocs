<?php
/**
 * Template Name: Univ Blog Left Sidebar
 *
 * The template for displaying blog page with left sidebar
 *
 * @package Layers
 * @since Layers 1.0.0
 */
			...
			<div class="grid">	
				...
				if ( $wp_query->have_posts() ) : ?>
					...
					<?php while ( $wp_query->have_posts() ) : $wp_query->the_post();?>
						<div class="blog-info-left column span-12 ricpro-post-widget-left-sidebar" id="post-<?php the_ID(); ?>">
						
							<div class="single-blog-item single-blog-pading">	
								<?php if ( has_post_thumbnail() ) { ?>
								<div class="single-blog-image">
										<?php /**
										* Display the Featured Thumbnail
										*/
										echo layers_post_featured_media( array( 'postid' => get_the_ID(), 'wrap_class' => 'overlay-effect', 'size' => 'univ_left_blog_image' ) ); ?>
								</div>
								<?php }else{ ?>
									<?php /**
										* Display the Featured Thumbnail
