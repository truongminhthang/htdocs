 ...
 * @since Layers 1.0.0
 */
if( class_exists('Layers_Widget') && !class_exists( 'univ_testimonial_Widget' ) ) {	
	class univ_testimonial_Widget extends Layers_Widget {
		...
		*/
		function __construct(){
			...
			*/
			$this->widget_title = __( 'Univ:: Testimonial' , 'univ' );
			$this->widget_id = 'testimonial';
			$this->post_type = 'univ_testimonial';
			$this->taxonomy = 'testimonial_category';
			...
			$this->defaults = array (
				'title' => __( 'Our Testimonials', 'univ' ),
				'excerpt' => __( 'How real people said about Univ', 'univ' ),
				'category' => 0,
				'show_media' => 'on',
				'show_titles' => 'on',
				'stylet1' => 'on',
									...
									<div class="<?php echo $post_column_class; ?>" data-cols="<?php echo $col_count; ?>">
										<div class="single-testimonial-carousel">
												...
												<div class="testimonial-information">
													...
													<?php  $name_client  = get_post_meta( get_the_ID(),'_univ_name', true );?>
													<?php  $degree  = get_post_meta( get_the_ID(),'_univ_degree', true );?>
													<?php  $batch_name  = get_post_meta( get_the_ID(),'_univ_batch_name', true );?>
													<?php if( $name_client || $degree || $batch_name ) { ?>
														<div class="testimonial-name">
															<h4><?php echo $name_client;?></h4>
															<span><?php echo $degree;?></span>
															<span><?php echo $batch_name;?></span>
														</div>
													<?php } ?>
												</div>
											</div>										
	...
	// Add our function to the widgets_init hook.
	 register_widget("univ_testimonial_Widget");
}