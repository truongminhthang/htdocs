 ...
 * Service Widget
 *
 * This file is used to register and display the Univ - Service widget.
 *
 * @package Layers
 * @since Layers 1.0.0
 */

if( class_exists('Layers_Widget') && !class_exists( 'Univ_Service_Widget' ) ) {
	class Univ_Service_Widget extends Layers_Widget {
		...
		*/
		function __construct() {
			...
			*/
			$this->widget_title = __( 'Univ:: Get In Touch' , 'univ' );
			$this->widget_id = 'univ_service';
			$this->post_type = '';
			$this->taxonomy = '';
			...
			$widget_ops = array(
				...
				'description' => __( 'This widget is used to display univ service box in a flexible grid.', 'univ' ),
			...
			$this->defaults = array (
				'title' => __( 'Get In Touch', 'univ' ),
				'excerpt' => __( 'Uaerat litora, taciti quaerat dolor ligula laoreet omnis aut scelerisque ex fuga platea eveniet pulvinar praesent molestiae maiores, quidem cumque!', 'univ' ),
				'design' => array(
					'layout' => 'layout-boxed',
					'liststyle' => 'list-grid',
					'gutter' => 'on',
		...
		*/
		function widget( $args, $instance ) {
			...
			*/
			...
			$widget_container_class[] = 'univ-services-wrapper';
						...
						<div class="grid">
							<?php foreach ( $column_ids as $column_key ) {
								...
								*/
								...
								$classes[] = 'service-box-single-column';
								...
								<div id="<?php echo $widget_id; ?>-<?php echo $column_key; ?>" class="<?php echo esc_attr( $classes ); ?>">
									...
									*/
									...
									$column_inner_classes[] = 'single-service-box';
...
<?php } ?>
				...
				<section class="layers-accordion-section layers-content">
					<?php $this->design_bar(
						...
						apply_filters( 'layers_column_widget_column_design_bar_components', array( // Components
							...
							'fonts' => array(
								'elements' => array(
									'service-icon-color' => array(
										'type' => 'color',
										'label' => __( 'Icon Color' , 'univ' ),
										'name' => $this->get_layers_field_name( 'service-icon-color' ),
										'id' => $this->get_layers_field_id( 'service-icon-color' ),
										'value' => ( isset( $item_instance['service-icon-color'] ) ) ? $item_instance['service-icon-color'] : NULL,
	...
	// Add our function to the widgets_init hook.
	 register_widget("Univ_Service_Widget");
}