 ...
 * Classes Widget
 *
 * This file is used to register and display the Layers - Classes widget.
 *
 * @package Layers
 * @since Layers 1.0.0
 */
if( class_exists('Layers_Widget') && !class_exists( 'univ_classes_Widget' ) ) {	
	class univ_classes_Widget extends Layers_Widget {
		...
		*/
		function __construct(){
			...
			*/
			$this->widget_title = __( 'Univ:: Courses' , 'univ' );
			$this->widget_id = 'classes';
			$this->post_type = 'univ_classes';
			$this->taxonomy = 'classes_category';
			...
			$this->defaults = array (
				'title' => __( 'Our Courses', 'univ' ),
				'excerpt' => __( 'Our preschool program has six dedicated classes', 'univ' ),
				'text_style' => 'regular',
				'category' => 0,
				'show_media' => 'on',
				'show_titles' => 'on',
		...
		function widget( $args, $instance ) {
			...
			*/
								...
								<?php while( $post_query->have_posts() ) {
									$post_query->the_post();
										...
										*/
										...
										$post_column_class[] = 'single-class';
										$post_column_class[] = 'dddd';
										...
										<?php // Layers Featured Media											
											if( isset( $instance['show_media'] ) ) {?>
												<a href="<?php the_permalink(); ?>">
													<?php the_post_thumbnail('univ_class_image'); ?>
													
													
														<?php if( isset( $instance['circle_text'] ) && !empty( $instance['circle_text'] ) ) { ?>
															<span class="class-date"><?php echo $instance['circle_text']; ?> </span>
														<?php }else{?>
								...
								<?php } ?>
									<?php if( isset( $instance['show_content'] ) ) { ?>
										<div class="single-class-text">
											...
											<?php if( isset( $instance['show_age'] ) ) { ?>
											...
											//end Content?>	</p>
											<span class="arrow"><a href="<?php the_permalink(); ?>">Read More</a></span>
											</div>
			...
			<?php } elseif( isset( $instance['styleclass2'] ) ) { ?>				
						...
						<div class="class-yellow <?php echo $this->get_widget_layout_class( $instance ); ?>">
								<?php if( isset( $instance['carsolshow'] ) ) { ?>
									<div class="grid">
										<div class="class-carousel carousel-style-one">
								 <?php } else { ?>	
				...
				apply_filters( 'layers_post_widget_design_bar_components' , array( // Components
					...
					'display' => array(
						...
						'elements' => array(
							...
							'show_age' => array(
								'type' => 'checkbox',
								'name' => $this->get_layers_field_name( 'show_age' ) ,
								'id' => $this->get_layers_field_id( 'show_age' ) ,
								'value' => ( isset( $instance['show_age'] ) ) ? $instance['show_age'] : NULL,
								'label' => __( 'Show Age Option' , 'univ' )
							),
							...
							'circle_text' => array(
								'type' => 'text',
								'name' => $this->get_layers_field_name( 'circle_text' ) ,
								'id' => $this->get_layers_field_id( 'circle_text' ) ,
								'value' => ( isset( $instance['circle_text'] ) ) ? $instance['circle_text'] : NULL,
								'label' => __( 'Set Circle Text' , 'univ' ),
							),							
	...
	// Add our function to the widgets_init hook.
	 register_widget("univ_classes_Widget");
}